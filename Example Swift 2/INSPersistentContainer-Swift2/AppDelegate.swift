...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        let stack = INSDataStackContainer.containerWithName("INSPersistentContainer")
        let desc = (stack.persistentStoreDescriptions as NSArray).firstObject as? NSPersistentStoreDescription
